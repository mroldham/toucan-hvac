...
def ui_add_equipment(property_id):
    ...
    if request.method == "POST":
        eq = Equipment(
            ...
            filter_size=request.form.get("filter_size"),
            filter_brand=request.form.get("filter_brand"),
            filter_quantity=request.form.get("filter_quantity"),
            last_filter_change=request.form.get("last_filter_change"),
            filter_interval_days=int(request.form.get("filter_interval_days") or 90),
            filter_notes=request.form.get("filter_notes"),
...
def ui_edit_equipment(equipment_id):
    ...
    if request.method == "POST":
        ...
        equipment.filter_brand = request.form.get("filter_brand")
        equipment.filter_quantity = request.form.get("filter_quantity")
